 ...
 */
  function scoreRecipe(recipe, goalKey, targetCalories, targetProtein, timingWeights, usedProteins = new Set(), fiberNeeded = false, weeklyRecipeCount = {}, slugHistory = {}, currentWeekNum = 1, profile = null, proteinBudgetRemaining = 999) {
...
function selectRecipeForMeal(recipes, profile, mealType, targetCalories, targetProtein, usedSlugsByMealType, mealTiming, usedProteins = new Set(), fiberNeeded = false, weeklyRecipeCount = {}, slugHistory = {}, currentWeekNum = 1, usedSlugsToday = new Set(), proteinBudgetRemaining = 999) {
const goalKey    = profile.goalNormalized;
  ...
  const sorted = [...pool].sort((a, b) =>
    scoreRecipe(b, goalKey, targetCalories, targetProtein, timingWeights, usedProteins, fiberNeeded, weeklyRecipeCount, slugHistory, currentWeekNum, profile, proteinBudgetRemaining) -
    scoreRecipe(a, goalKey, targetCalories, targetProtein, timingWeights, usedProteins, fiberNeeded, weeklyRecipeCount, slugHistory, currentWeekNum, profile, proteinBudgetRemaining)
  );
...
function buildDayNutrition(recipes, profile, isTrainingDay, usedSlugsByMealType, workoutHour, dailyProteinSources, dateStr, recentProteinsByDate, phase = "base", slugHistory = {}, currentWeekNum = 1, calorieSurplusFromPrev = 0, consecutiveSmoothingDays = 0) {
  ...
  for (const mealType of mealTypes) {
    ...
    const recipe = selectRecipeForMeal(
      ...
      slugHistory, currentWeekNum, usedSlugsToday, proteinBudgetRemaining  // [v23]
    );
